...
export default function DispatchesList() {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div className="flex flex-wrap items-center justify-between gap-4 animate-fadeIn">
                <div>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <select
                        ...
                        className="px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-sm"
                    >
