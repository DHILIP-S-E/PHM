...
export default function BrandsPage() {
    ...
    return (
        <PageLayout
            title="Brands"
            description="Manage medicine brand masters"
            icon="label"
            actions={
            ...
            <Card className="!p-0">
                {loading ? (
                    ...
                    <div className="py-16 text-center">
                        <span className="material-symbols-outlined text-5xl text-slate-300 mb-3">label</span>
                        <h3 className="text-lg font-medium text-slate-900 dark:text-white">No Brands</h3>
                        <p className="text-slate-500 mt-1">Create medicine brand masters</p>
